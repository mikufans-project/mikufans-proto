...
pub mod region_server {
    ...
    pub trait Region: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn region(
            &self,
            request: tonic::Request<super::RegionReq>,
        ) -> std::result::Result<tonic::Response<super::RegionReply>, tonic::Status>;
    }
    ///
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/bilibili.app.show.region.v1.Region/Region" => {
                    ...
                    struct RegionSvc<T: Region>(pub Arc<T>);
                    impl<T: Region> tonic::server::UnaryService<super::RegionReq>
                    for RegionSvc<T> {
                        type Response = super::RegionReply;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Region>::region(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "bilibili.app.show.region.v1.Region";
