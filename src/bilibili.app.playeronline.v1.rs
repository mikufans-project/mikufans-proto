...
pub mod player_online_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with PlayerOnlineServer.
    #[async_trait]
    pub trait PlayerOnline: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn player_online(
            &self,
            request: tonic::Request<super::PlayerOnlineReq>,
        ) -> std::result::Result<
            tonic::Response<super::PlayerOnlineReply>,
            tonic::Status,
        >;
        ///
        async fn premiere_info(
            &self,
            request: tonic::Request<super::PremiereInfoReq>,
        ) -> std::result::Result<
            tonic::Response<super::PremiereInfoReply>,
            tonic::Status,
        >;
        ...
        async fn report_watch(
            &self,
            request: tonic::Request<super::ReportWatchReq>,
        ) -> std::result::Result<tonic::Response<super::NoReply>, tonic::Status>;
    }
    ///
    #[derive(Debug)]
    pub struct PlayerOnlineServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for PlayerOnlineServer<T>
    where
        T: PlayerOnline,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/bilibili.app.playeronline.v1.PlayerOnline/PlayerOnline" => {
                    ...
                    struct PlayerOnlineSvc<T: PlayerOnline>(pub Arc<T>);
                    impl<
                        T: PlayerOnline,
                    > tonic::server::UnaryService<super::PlayerOnlineReq>
                    for PlayerOnlineSvc<T> {
                        type Response = super::PlayerOnlineReply;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as PlayerOnline>::player_online(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = PlayerOnlineSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/bilibili.app.playeronline.v1.PlayerOnline/PremiereInfo" => {
                    #[allow(non_camel_case_types)]
                    struct PremiereInfoSvc<T: PlayerOnline>(pub Arc<T>);
                    impl<
                        T: PlayerOnline,
                    > tonic::server::UnaryService<super::PremiereInfoReq>
                    for PremiereInfoSvc<T> {
                        type Response = super::PremiereInfoReply;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PlayerOnline>::premiere_info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PremiereInfoSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/bilibili.app.playeronline.v1.PlayerOnline/ReportWatch" => {
                    #[allow(non_camel_case_types)]
                    struct ReportWatchSvc<T: PlayerOnline>(pub Arc<T>);
                    impl<
                        T: PlayerOnline,
                    > tonic::server::UnaryService<super::ReportWatchReq>
                    for ReportWatchSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PlayerOnline>::report_watch(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReportWatchSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for PlayerOnlineServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "bilibili.app.playeronline.v1.PlayerOnline";
    impl<T> tonic::server::NamedService for PlayerOnlineServer<T> {
