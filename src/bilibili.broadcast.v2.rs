...
pub mod laser_server {
                ...
                "/bilibili.broadcast.v2.Laser/WatchEvent" => {
                    ...
                    impl<T: Laser> tonic::server::UnaryService<()> for WatchEventSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as Laser>::watch_event(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = WatchEventSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "bilibili.broadcast.v2.Laser";
